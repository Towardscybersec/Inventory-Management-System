...
from librabry import Ui_MainWindow
...
class Login(QWidget , Ui_Form):
    ...
    def Handle_Login(self):
        self.db = MySQLdb.connect(host='localhost', user='root', password='raja', db='library')
...
class MainApp(QMainWindow , Ui_MainWindow):
    ...
    def Handle_UI_Changes(self):
        self.Hiding_Themes()
        self.tabWidget.tabBar().setVisible(False)  #hide tab widget
    ...
    def Handle_Buttons(self):
        ...
        self.pushButton_5.clicked.connect(self.Open_Setting_Tab)
        ...
        self.pushButton_6.clicked.connect(self.Dark_Blue_Theme)
        ...
        self.pushButton_14.clicked.connect(self.Handel_Day_Operations)
    ...
    def Handel_Day_Operations(self):
        ...
        client_name = self.lineEdit_30.text()
...
# ******************* Items ********************#
    ...
    def Edit_Books(self):
        ...
        book_code = self.lineEdit_22.text()
        ...
        search_book_title= self.lineEdit_6.text()
    ...
    def Delete_Client(self):
        ...
        warning_message = QMessageBox.warning(self, "Delete Client" , "Are you sure that you want to delete this client" , QMessageBox.Yes | QMessageBox.No)
